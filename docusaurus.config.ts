...
const config: Config = {
  ...
  themeConfig: {
    ...
    navbar: {
      title: 'Physical AI & Humanoid Robotics',
      logo: {
        alt: 'Physical AI & Humanoid Robotics Book by Chand Afatima',
        src: 'img/logo.svg',
      },
      items: [
        {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Physical AI & Humanoid Robotics Book by Chand Afatima. Built with Docusaurus.`,
    },
    prism: {
